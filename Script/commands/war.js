...
module.exports.run = async function({ api, args, Users, event}) {
 ...
 setTimeout(() => {a({body: "এই মুরগি খাংকির পোলা মনির তর আম্মুর বাতার লাগে বাস্ট্রাডের বাচ্ছা গালি বাজ হয়ে গেসিস" })}, 3000);
 ...
 setTimeout(() => {a({body: "খাংকির পোলা তুইই মনির কে গালি দেস তুই তো রাস্তার পতিতার পুত ছোডো ভাই তর আম্মু রে টুস করে চুদে দিয়ে দূর দিভো 🐒🙈?" })}, 12000);
